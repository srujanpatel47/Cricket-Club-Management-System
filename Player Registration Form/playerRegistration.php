          ...
          <form action="playerRegistration.php" method="post" role="form">
            <div class="row">
              ...
              <table id="form-table" class="table table-striped">
                ...
                <tbody id="table-body">
                  <tr>
                    <td><input class="col-xs-12" type="text" name="clubname_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="club_from_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="club_to_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="total_run_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="total_wicket_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="team_leader_01" value="" ></td>
                  </tr>
                  <tr>
              ...
              <table id="form-table" class="table table-striped">
                ...
                <tbody id="table-body">
                  <tr>
                    <td><input class="col-xs-12" type="text" name="bp_clubname_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="bp_opp_club_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="bp_eventid_01" value="" "></td>
                    <td><input class="col-xs-12" type="text" name="bp_match_id_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="bp_run_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="bp_wicket_01" value="" ></td>
                  </tr>
                  <tr>
              ...
              <table id="form-table" class="table table-striped">
                ...
                <tbody id="table-body">
                  <tr>
                    <td><input class="col-xs-12" type="text" name="degree_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="ins_dept_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="board_uni_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="pass_year_01" value="" ></td>
                    <td><input class="col-xs-12" type="text" name="result_01" value="" ></td>
                  </tr>
                  <tr>
              ...
              <div class="radio">
                <label><input type="radio" name="member-radio" value="iccb">ICC</label>
              </div>
              <div class="radio">
                <label><input type="radio" name="member-radio" value="bccb">BCCI</label>
              </div>
              <div class="radio">
